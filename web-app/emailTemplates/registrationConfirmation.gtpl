	...
	<div class="resetWrapper notes">
		...
		<div class="resetForm">
			<p class="large" style="font-size:17px; line-height:1.5em;text-decoration:none;margin:10px auto 30px auto;">
				...
				<span class="small">This email has been sent to inform you that you have successfully registered for Franklin's 13+.  Hope you get some value from it...  best of luck.</span>
				  <a href="http://franklins13app.com" class="button blue small">Start Logging Your Results</a>
			</p>
		</div>
