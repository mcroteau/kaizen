	...
	<div class="content logentry" style="display:none">
		...
		<div class="buttons">
		    <g:form>
				...
				<g:actionSubmit class="edit" action="edit" class="button small blue" value="Edit Entry" />
				
		        <g:actionSubmit class="delete" action="delete" class="button small red" value="Delete" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
...
$(document).ready(function(){
	...
	var LogEntry = function(){
		...
		self.disableElements = function(){
			...
			$('#happinessScaleValue').attr('disabled', 'disabled');	
