...
<body>
	...
	<div class="content logentry" style="display:none">
        ...
        <g:form action="update" >
			...
			<div class="buttons">	
				<g:actionSubmit action="delete" class="button small red" value="Delete" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
				
				<g:submitButton action="update" name="update" class="button small blue">Update Entry</g:submitButton>
			</div>
